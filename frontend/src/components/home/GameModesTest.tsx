        ...
        <div id="games-and-points" ref={first_section} className={`grid grid-cols-2  mt-[35px] ml-[169px] mr-[169px] gap-[${section_gap}px] xl:gap-[${section_gap_xl}px]`}>
            ...
            <section ref={ref} id="game-mode-section" className="">
                ...
                <div id="modes" className="grid grid-cols-4 gap-[10px]">
                    ...
                    } fill="[color:#301D13]" cornerredius="3" stroke="[color:#4E301F]" strokesize={3} cornershape={[24,0,24,0]} width={139} height={112} margine="mr-[10px]"  ratio={80/100}/>

                    <CornerLinedCardTest childComp={
                        <img className="center w-[46%]" src={Cursed} alt="" />
                    } fill="[color:#041F1E]" cornerredius="3" stroke="[color:#073736]" strokesize={3} width={139} height={112} cornershape={[24,0,24,0]} margine="mr-[10px]"  ratio={80/100}/>

                    <CornerLinedCardTest childComp={
                        <img className="center w-[46%]" src={Vanish} alt="" />
                    } fill="[color:#1D1333]" cornerredius="3" stroke="[color:#332158]" cornershape={[24,0,24,0]} strokesize={3} width={139} height={112} margine="mr-[10px]"  ratio={80/100}/>

                    <CornerLinedCardTest childComp={
                        <img className="center w-[46%]" src={Goldrush} alt="" />
                    } fill="[color:#241D0C]" cornerredius="3" stroke="[color:#413415]"  cornershape={[24,0,24,0]} strokesize={3} width={139} height={112} margine="mr-[10px]" ratio={80/100}/>
         
                </div>
                <div id="play-card" className={`w-[${play_size}px]`}>
                    <CornerLinedCardTest childComp={
                        <h2 className={`play font-Rowdies text-[${font_size}px]`}> PLAY </h2>
                    } fill="[color:#FE5821]" cornerredius="3" stroke="[color:#FE5821]"  cornershape={[24,0,24,0]} strokesize={0} width={200} height={87} margine="mt-[28px]" ratio={43/100} />
                </div>
            </section>
