  ...
  return (
    <>
      ...
      >
        <div
          id="message-profile"
          className="relative flex justify-start gap-[3px] h-[100%]"
        >
          <img
            src={aamoussa}
            alt="profile"
            className="w-[10%] h-[100%]  rounded-full order-0"
          />
        ...
        <div className="flex w-full justify-start">
          <div
            id="message-content"
            className="flex bg-[#2B2F33] w-fit max-w-[100%] rounded-[12px] rounded-tl-[0px]"
          >
            <p
              style={{ color: 'rgba(255, 255, 255, 0.8)' }}
              className="color-[white] break-all font-sans text-[10px] m-[10px]"
            >
              HADAK ghir message khawi
            </p>
          </div>
        </div>
      </div>
