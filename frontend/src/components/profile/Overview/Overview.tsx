import { AchievementIcon, LoseIcon, WonIcon, PointsIcon } from '@assets/profileIcons';
import MatchCard from '@components/MatchCard';
import { Game, CardType, User } from '@globalTypes/types';
...
import { ach } from '@globalTypes/achievements.ts';
  ...
  return (
    <div id="OverviewView" className="h-screen overflow-auto">
      ...
      >
        ...
        <OverviewCard footer="Unlocked Achievments" number={achievements.length}>
