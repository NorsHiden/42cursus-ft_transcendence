    ...
    <div id="AboutMe" className={className}>
      <div className="flex">
        <div className="relative flex-shrink-0 h-24 w-24 rounded-full ">
          <div className="absolute top-1 right-1 h-4 w-4 bg-green border-[2px] border-background rounded-full"></div>
          <img
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="font-sans text-[0.5vw] font-extrabold ml-[0.72vw]  text-gray ">
            @{user.username}
          </p>
        </div>
      </div>
