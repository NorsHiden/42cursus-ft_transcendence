...
const BagSolid: React.FC<IconProps> = ({ size, className }) => {
  return (
    <svg
      width={size || 24}
      height={size || 24}
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M14.5528 2.10558C15.0468 1.85859 15.6475 2.05882 15.8945 2.5528L17.6833 6.1305C17.9303 6.62448 17.7301 7.22516 17.2361 7.47214C16.7421 7.71913 16.1414 7.51891 15.8945 7.02493L14.1056 3.44722C13.8586 2.95324 14.0588 2.35257 14.5528 2.10558Z"
      />
    </svg>
  );
};
