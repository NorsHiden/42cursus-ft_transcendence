...
const PhoneCallOutline: React.FC<IconProps> = ({ size, className }) => {
  return (
  <svg
    width={size || 24}
    height={size || 24}
  ...
  >
    <path
      d="M16.6922 10.2726C16.4505 9.61627 16.0739 9.01789 15.5865 8.51618C15.0992 8.01447 14.512 7.62058 13.8629 7.35999"
      stroke="currentColor"
      strokeWidth={2}
      strokeLinecap="round"
    />
    <path
      d="M20.6933 9.6706C20.2844 8.1446 19.4811 6.75312 18.364 5.63601C17.2469 4.5189 15.8554 3.71553 14.3294 3.30664"
      stroke="currentColor"
      strokeWidth={2}
      strokeLinecap="round"
    />
