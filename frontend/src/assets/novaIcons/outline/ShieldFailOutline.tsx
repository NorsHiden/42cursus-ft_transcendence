...
const ShieldFailOutline: React.FC<IconProps> = ({ size, className }) => {
  return (
  <svg
    width={size || 24}
    height={size || 24}
  ...
  >
    <path
      ...
      strokeWidth={2}
    />
    <path d="M10 9L14 13M14 9L10 13" stroke="currentColor" strokeWidth={2} strokeLinecap="round" />
  </svg>
  );
};

export default ShieldFailOutline;